...
<%--                                    &lt;%&ndash;                                        <label class="col-md-3 control-label">&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                            项目名称&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                        </label>&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                        <div class="col-md-9">&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                            <select class="table-group-action-input form-control input-medium"&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                                    id="project_id_select" name="project_id_select">&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                                <option value="1">&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                                    （无）&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                                </option>&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                            </select>&ndash;%&gt;--%>
<%--                                    &lt;%&ndash;                                        </div>&ndash;%&gt;--%>
...
<%--                                        最后一个--%>
<%--                                    </button>--%>
<%--                                    &lt;%&ndash;										<label class="btn red">注意：单页浏览设计得过于复杂难懂，仅作为进阶参考，初步入门可不管这个</label>&ndash;%&gt;--%>
<%--                                </div>--%>
<%--                                <div class="form-actions right1">--%>
<%--&lt;%&ndash;                                    <button type="button" id="submit_button" class="btn green" title="把修改好的信息提交到后台保存">&ndash;%&gt;--%>
<%--&lt;%&ndash;                                        提交修改&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    </button>&ndash;%&gt;--%>
...
<%--                                    </div>--%>
<%--                                </div>--%>
<%--                                &lt;%&ndash;                                <div style="clear:both;width:auto;height:100px;margin:5px;border:1px solid lightgrey;text-align: center;">&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                    <div style="float:left;border:0px solid green;text-align: center;margin:5px;">&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <img src="../../assets/module/img/security/user/avatar/avatar.jpg" style="width:18px;height:auto;border-radius:50%!important;border:0px solid red;">&ndash;%&gt;--%>
<%--                                &lt;%&ndash;&lt;%&ndash;                                        <img src="" style="width:18px;height:auto;border-radius:50%!important;border:0px solid red;">&ndash;%&gt;&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <div style="text-align: center; color: black;"><p>生来彷徨</p></div>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <div class="comt-meta" ><span class="comt-author"></span>2019-05-07 01:16:16</div>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                    <div style="width:auto;height:100px;display:table-cell;margin-left:10px;margin-right:10px;margin-top:10px;margin-bottom:10px;border:0px solid blue;text-align: center;">&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                        <p><span>不错不错不错</span></p>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                    </div>&ndash;%&gt;--%>
<%--                                &lt;%&ndash;                                </div>&ndash;%&gt;--%>
<%--                            </form>--%>
<%--                        </div>--%>
