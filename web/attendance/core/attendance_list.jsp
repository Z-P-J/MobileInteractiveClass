            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet box blue ">
                        <div style="text-align: center; color: white;"><h1>考勤管理</h1></div>
                            ...
                            <form class="form-horizontal" role="form" method="post" id="page_form" name="page_form"
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <%--&lt;%&ndash;												<button type="button" id="add_button" class="btn green" title="添加新的记录">&ndash;%&gt;--%>
                                        <%--&lt;%&ndash;													上传文件&ndash;%&gt;--%>
                                        <%--&lt;%&ndash;												</button>&ndash;%&gt;--%>
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/attendance/attendance_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->