				...
				<div class="row">
					<div class="col-md-12">
						<div class="portlet box blue ">
							<div style="text-align: center; color: white;"><h1>课程管理</h1></div>
									...
									<div class="form-body">
										<div class="form-group">
											<div class="btn-group"
												...
												<a id="search_button_1" class="btn green" href="course_query_div.jsp"
												   data-target="#ajax" data-toggle="modal">查询课程</a>
											</div>
											<div class="btn-group"
												 style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 10px; margin-top: 10px;">
												<a id="add_course" class="btn green"
                                                   href="course_add_div.jsp" data-target="#ajax"
                                                   data-toggle="modal" style="display: none">添加课程 <i class="fa fa-plus"></i> </a>
											</div>
											<div class="btn-group"
												 style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 10px; margin-top: 10px;">
												<a id="join_course" class="btn green"
												   href="course_join_div.jsp" data-target="#ajax"
												   data-toggle="modal" style="display: none">加入课程 <i class="fa fa-plus"></i> </a>
											</div>
											<div class="btn-group"
												 style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 10px; margin-top: 10px;display: none">
												<a id="update_course" class="btn green"
												   href="course_update_div.jsp" data-target="#ajax"
												   data-toggle="modal">修改课程 <i class="fa fa-plus"></i> </a>
											</div>
											<div id="div_publish_attendance" class="btn-group"
												 style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 10px; margin-top: 10px;display: none">
												<a id="publish_attendance" class="btn green"
												   href="course_publish_attendance_div.jsp" data-target="#ajax"
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/course/course_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->