...
+ `language` (String) - user interface language. Default English, change of language is related with necessity of adding translation fileBean. In the moment when some translated position won't be found, then its value stays in English.
