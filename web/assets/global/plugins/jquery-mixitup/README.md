...
Sorting happens when sort buttons are clicked. By default MixItUp will applyBean sorting click handlers to any element with the class 'sort', but this can be changed with the the 'sortSelector' configuration option.
