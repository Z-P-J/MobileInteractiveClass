...
var Record = function () {
    ...
    var initRecordListHeader = function () {
        ...
        html = html + "							<th>文件ID</th>";
        html = html + "							<th>上传用户</th>";
        html = html + "							<th>文件名</th>";
        html = html + "							<th>文件大小</th>";
        html = html + "							<th>上传时间</th>";
        html = html + "							<th>下载链接</th>";
        html = html + "						</tr>";
    ...
    var deleteRecord = function (id) {
        ...
        if (id != null) {
            selectedCount = 1;
            url = "../../" + module + "_" + sub + "_servlet_action?action=delete_record&id=" + id;
        } else {
            var set = $('.datatable').find('.group-checkable').attr("data-set");
            url = "../../" + module + "_" + sub + "_servlet_action?action=delete_record";
            jQuery(set).each(function () {
