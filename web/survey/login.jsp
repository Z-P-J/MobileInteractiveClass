...
<head>
    ...
    <link href="../assets/survey/images/login.css" rel="stylesheet" type="text/css"/>
...
<div id="wrap">
    ...
    <div id="content-wrap">
        ...
        <form name="from1" action="login.jsp" method="post">
            <div class="content">
                <div class="field"><label>账　户：</label><input class="username" name="username" value="" type="text"
                                                             id="username"/></div>
                <div class="field"><label>密　码：</label><input class="pwd" name="pwd" value="" type="password"
                                                             id="password"/><br/></div>
                <div class="field"><label><br/>
                    <div class="yzm-box"></div>
                </div>
                <div class="btn"><input name="submit" type="submit" class="login-btn" value="" onclick="return sub();"/>
                </div>
            </div>
        </form>
    </div>
