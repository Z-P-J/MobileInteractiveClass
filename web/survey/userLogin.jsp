    ...
    <div id="content-wrap">
        ...
        <form name="from1" action="<%=basePath%>user/userLogin.do?op=userLogin" method="post" id="from1">
            <div class="content">
                ...
                <div class="field"><label>账　户：</label><input class="username" name="nickname" value="" type="text"/>
                </div>
                <div class="field"><label>密　码：</label><input class="password" name="password" value="" type="password"/><br/>
                </div>
                <div class="field"><br/>
                </div>
