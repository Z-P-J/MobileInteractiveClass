...
<head>
    ...
    <link rel="stylesheet" href="../assets/survey/css/Style.css" type="text/css"/>
...
<div id="head">
    <div>
        <img src="../assets/survey/images/head.jpg;" style="width:770px;height:180px">
        <span>
    ...
    <div id="main_1">
        ...
        <div class="head_new_list">
            <ol>
                ...
                </a>&nbsp;&nbsp;&nbsp;&nbsp;<i><font color=grey><%=s.getSCreateDate() %>
                </font></i></li>
                <%
                        i++;
                    }
        ...
        <ul>
            ...
            <%
                ...
                for (Link link : llist) {
                    ...
                    j++;
            %>
            <li class=friendBox><a href=<%=link.getLUrl() %> target="_blank"><%=link.getLName()%>
            </a></li>
