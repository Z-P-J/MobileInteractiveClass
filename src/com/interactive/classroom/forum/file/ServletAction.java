package com.interactive.classroom.forum.file;
/*
 * 待完成：用MVC模式分开DB和Action操作
 * 增删改查看导印统功能的实现
 */

import com.interactive.classroom.forum.dao.FileDao;
import com.interactive.classroom.forum.dao.ForumFile;
...
public class ServletAction extends HttpServlet {
    ...
    public void exportData(JSONObject jsonObj, String filePathName) throws Exception {
        if (jsonObj != null) {
            ...
            ExcelWriter.creExcel(jsonObj, "卡口统计", cols, filePathName);
            jsonObj.put("result_code", 0);
