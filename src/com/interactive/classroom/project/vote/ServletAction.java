//package com.interactive.classroom.project.vote;
///*
...
//import com.interactive.classroom.project.dao.VoteBean;
//import com.interactive.classroom.project.dao.VoteDao;
...
//    private static final String SUB = "vote";
//
...
//        Log.d(getClass().getName(), "VoteBean=" + bean.toString());
//
...
//        bean.setContent(request.getParameter("content"));
//        bean.setLimitTime(request.getParameter("limit_time"));
//        bean.setUserId(userId);
...
//        initUserInfo(session);
//        VoteDao dao = new VoteDao();
//        JSONObject jsonObj = dao.setRecordTop(request.getParameter("action"), request.getParameter("type"), userId, request.getParameter("id"));
//        jsonObj.put("user_id", userId);
//        jsonObj.put("user_name", userName);
//
//        session.setAttribute(MODULE + "_" + SUB + "_get_record_result", jsonObj);
