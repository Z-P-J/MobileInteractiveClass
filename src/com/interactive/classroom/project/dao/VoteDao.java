...
public class VoteDao {
    ...
    private static final String TABLE_NAME = "project_vote";
    ...
    public JSONObject modifyRecord(VoteBean bean) throws JSONException {
...
//			ylx_db query_db = new ylx_db(bean.getDbName());
            //构造sql语句，根据传递过来的查询条件参数
            String sql = "update " + TABLE_NAME + " set title='" + bean.getTitle() + "',content='" + bean.getContent() + "',limit_time='" + bean.getLimitTime() + "' where id=" + bean.getId();
...
//			ylx_db query_db = new ylx_db(dbName);
    ...
    public JSONObject addRecord(VoteBean bean) throws JSONException, SQLException {
        String resultMsg = "ok";
        int resultCode = 0;
        List jsonList = new ArrayList();
//		ylx_db query_db = new ylx_db(bean.getDbName());
        //构造sql语句，根据传递过来的查询条件参数
        String sql = "insert into " + TABLE_NAME + "(parent_id,title,content,limit_time,user_id,creator,create_time,link,end_time) values('" + bean.getParentId() + "','" + bean.getTitle() + "','" + bean.getContent() +
                "','" + bean.getLimitTime() + "','" + bean.getUserId() + "','" + bean.getCreator() + "','" + bean.getCreateTime() + "','" + bean.getLink() + "','" + bean.getLimitTime() + "')";
