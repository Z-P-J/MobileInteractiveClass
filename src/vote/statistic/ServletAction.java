package vote.statistic;//package vote.statistic;
///*
// * 增删改查看导印统功能的实现
...
//import vote.dao.Statistic;
//import vote.dao.StatisticDao;
...
//            resultUrl = resultPath + "/vote_statistic_result.jsp";
...
//        JSONObject jsonObj = new JSONObject();
//		/*----------------------------------------数据获取完毕，开始返回数值*/
//        if (session.getAttribute("vote_file_statistic_query_time_from") != null) {
//            jsonObj.put("time_from", (String) session.getAttribute("vote_file_statistic_query_time_from"));
//        } else {
//            resultCode = 1;
//        }
//        if (session.getAttribute("vote_file_statistic_query_time_to") != null) {
//            jsonObj.put("time_to", (String) session.getAttribute("vote_file_statistic_query_time_to"));
//        } else {
//        }
//        if (session.getAttribute("vote_file_statistic_query_timeinterval") != null) {
//            jsonObj.put("time_interval", (String) session.getAttribute("vote_file_statistic_query_timeinterval"));
//        } else {
//        }
//        if (session.getAttribute("vote_file_statistic_query_addressid") != null) {
//            jsonObj.put("address_id", (String) session.getAttribute("vote_file_statistic_query_addressid"));
//        } else {
//        }
...
//        filePath = "C:\\upload\\vote\\export\\temp";
//        filePathName = filePath + "\\" + fileName;
//        fileUrl = "/upload/vote/export/temp/" + fileName;
//		/*--------------------赋值完毕--------------------*/
//        String dbName = (String) session.getAttribute("unit_db_name");
//        String action = request.getParameter("action");
//        String existResultset = request.getParameter("exist_resultset");
...
//            ExcelWriter.creExcel(jsonObj, "数据统计", cols, filePathName);
//            jsonObj.put("result_code", 0);
//            jsonObj.put("result_msg", "读取了上一次的查询配置");
//        }
//    }
