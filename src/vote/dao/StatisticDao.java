package vote.dao;//package vote.dao;
//
//import dao.ylx_db;
...
//			timeInterval="%Y-%m";
//		}
//		sql="select date_format(create_time,\""+timeInterval+"\") as time_interval,count(*) as count from vote_file a";
