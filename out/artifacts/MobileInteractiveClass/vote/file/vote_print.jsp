...
<%
    ...
    if (existResultset != null && existResultset.equals("1")) {
        jsonObj = (JSONObject) session.getAttribute("vote_file_get_record_result");
    }
...
<div>
    ...
    <div>
        ...
        <head>
            ...
            <link rel=File-List href="vote_print.files/filelist.xml">
            <!--[if gte mso 9]>
            <xml>
            ...
            <link rel=dataStoreItem href="vote_print.files/item0001.xml" target="vote_print.files/props0002.xml">
            <link rel=themeData href="vote_print.files/themedata.thmx">
            <link rel=colorSchemeMapping href="vote_print.files/colorschememapping.xml">
            <!--[if gte mso 9]>
            <xml>
                <w:WordDocument>
                ...
                <table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
                    ...
                    <tr style='mso-yfti-irow: 1'>
                        ...
                        <td width=102 valign=top
                            ...
                            <p class=MsoNormal>
								<span lang=EN-US style='font-size: 14.0pt'><o:p><%=projectId %>
                                </o:p>
								</span>
                            </p>
                        </td>
                        <td width=227 valign=top
                            ...
                            <p class=MsoNormal>
								<span lang=EN-US style='font-size: 14.0pt'><o:p><%=title %>
                                </o:p>
								</span>
                            </p>
                        </td>
                        <td width=132 valign=top
                            ...
                            <p class=MsoNormal>
								<span lang=EN-US style='font-size: 14.0pt'><o:p><%=limitTime %>
                                </o:p>
								</span>
                            </p>
                        </td>
                    ...
                    <tr style='mso-yfti-irow: 2; mso-yfti-lastrow: yes'>
                        <td width=555 colspan=4 valign=top
                            ...
                            <p class=MsoNormal align=right style='text-align: right'>
                                <span lang=EN-US style='font-size: 14.0pt'>2017</span><span
                                    ...
                                    lang=EN-US style='font-size: 14.0pt'>05</span><span
                                    ...
                                    lang=EN-US style='font-size: 14.0pt'>01</span><span
