...
<%--    <input type="hidden" id="action" name="action" value="<%=columns%>"/>--%>
    <input type="hidden" id="module_name" value="<%=moduleName%>"/>
...
<%--    <input type="button" style="display:none;" value="打印预览" onclick="WebBrowser.ExecWB(7,1)">--%>
    <div>
        ...
        <head>
            ...
            <link rel=File-List href="print.files/filelist.xml">
            <!--[if gte mso 9]>
            <xml>
            ...
            <link rel=dataStoreItem href="print.files/item0001.xml" target="print.files/props0002.xml">
            <link rel=themeData href="print.files/themedata.thmx">
            <link rel=colorSchemeMapping href="print.files/colorschememapping.xml">
            <!--[if gte mso 9]>
            <xml>
                <w:WordDocument>
        ...
        <div class=Section1 style='layout-grid: 15.6pt'>
            ...
            <div align=center>
                ...
                <table id="table_print" class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
...
<%--                    <tr id="tr_columns" style='mso-yfti-irow: 0; mso-yfti-firstrow: yes'>--%>
<%--                        <%--%>
...
<%--                                    <span style='font-size: 14.0pt; font-family: 宋体; mso-ascii-font-family: Calibri; mso-ascii-theme-font: minor-latin; mso-fareast-font-family: 宋体; mso-fareast-theme-font: minor-fareast; mso-hansi-font-family: Calibri; mso-hansi-theme-font: minor-latin'>--%>
<%--                                        <%=columnName%>--%>
<%--                                    </span>--%>
<%--                                </b>--%>
<%--                                <b style='mso-bidi-font-weight: normal'>--%>
...
<%--                                <span lang=EN-US style='font-size: 14.0pt'>2017</span>--%>
...
<%--                                <span lang=EN-US style='font-size: 14.0pt'>05</span>--%>
...
<%--                                <span lang=EN-US style='font-size: 14.0pt'>01</span>--%>
