...
<%--	<%@include servlet="../../home/frame/frame_style.jsp"%>--%>
<%--	<!-- BEGIN PAGE LEVEL STYLES -->--%>
<%--	<!-- END PAGE LEVEL SCRIPTS -->--%>
<%--</head>--%>
<%--<body class="page-header-fixed page-quick-sidebar-over-content page-sidebar-closed-hide-logo page-container-bg-solid">--%>
<%--	<%@include servlet="../../home/frame/frame_top.jsp"%>--%>
<%--	<div class="clearfix"></div>--%>
<%--	<!-- BEGIN CONTAINER -->--%>
<%--	<div class="page-container">--%>
<%--		<%@include servlet="../../home/frame/frame_left.jsp"%>--%>
<%--		<div class="page-content-wrapper">--%>
<%--			<!-- BEGIN CONTENT -->--%>
<%--			<div class="page-content">--%>
<%--				<%@include servlet="../../home/frame/frame_portlet.jsp"%>--%>
<%--				<%@include servlet="../../home/frame/frame_theme_color.jsp"%>--%>
<%--				<%@include servlet="../../home/frame/frame_page_header.jsp"%>--%>
<%--				<!-- BEGIN PAGE CONTENT-->--%>
<%--				<!-- ----------------------------------------页面开始，替换这里即可---------------------------------------- -->--%>
<%--				<div class="row">--%>
<%--					<div class="col-md-12">--%>
...
<%--			</div>--%>
<%--			<!-- END CONTENT -->--%>
<%--			<%@include servlet="../../home/frame/frame_sidebar.jsp"%>--%>
<%--		</div>--%>
<%--		<!-- END CONTENT WRAPPER-->--%>
<%--	</div>--%>
<%--	<!-- END CONTAINER -->--%>
<%--	<%@include servlet="../../home/frame/frame_bottom.jsp"%>--%>
<%--	<%@include servlet="../../home/frame/frame_ajax_modal.jsp"%>--%>
<%--</body>--%>
<%--</html>--%>
<%--<%@include servlet="../../home/frame/frame_page_component.jsp"%>--%>
<%--<%@include servlet="../../home/frame/frame_javascript.jsp"%>--%>
