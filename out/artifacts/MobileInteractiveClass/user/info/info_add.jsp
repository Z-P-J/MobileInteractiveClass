									...
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											<div class="form-group">
												...
												<div class="col-md-9">
													<select class="table-group-action-input form-control input-medium" id="userManage_id" name="userManage_id">
														<option value="1">（无）</option>
													</select>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">姓名（必填）<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="title" name="title" class="form-control" placeholder="请填写姓名" value=""/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">学号（必填）<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="content" name="content" class="form-control" placeholder="请输入学号" value=""/>
												</div>
											</div>
											<div class="form-group">
