...
var Record = function () {
    ...
    var initRecordList = function () {
        ...
        $('.datatable').dataTable({
            ...
            "oLanguage": {
                ...
                "sInfoEmpty": "显示第 0 至 0 项学生信息，共 0 项",
                "sInfoFiltered": "(由 _MAX_ 项学生信息过滤)",
                "sInfoPostFix": "",
                "sSearch": "过滤:",
                "oPaginate": {
                    "sFirst": "首页",
            ...
            "aLengthMenu": [[5, 10, 15, 20, 25, 40, 50, -1], [5, 10, 15, 20, 25, 40, 50, "所有学生信息"]],
    ...
    var addNew = function () {
        var userManageId = encodeURI(document.getElementById("userManage_id").value);
    ...
    var deleteRecord = function (id) {
        ...
        if (selectedCount > 0) {
            ...
            if (selectedCount == 1) {
                ...
                tip = "您确定要删除这 " + selectedCount + " 条学生信息吗？";
            }
            if (confirm(tip)) {
                $.post(url, function (e) {
                    processDeleteRecordResult(e);
                }).error(function (XMLHttpRequest, textStatus, errorThrown) {
    ...
    var processShowRecordById = function (data) {
        ...
        document.getElementById("userManage_id").value = list[0][1];
    ...
    var modifyRecord1 = function () {
        ...
        var userManageId = encodeURI(document.getElementById("group_id").value);
