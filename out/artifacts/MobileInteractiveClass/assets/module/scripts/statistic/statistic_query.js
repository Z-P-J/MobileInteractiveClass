...
var Record = function () {
    ...
    var getRecord = function () {
        ...
        var url = "../../" + module + "_servlet_action?action=get_record&id=" + id + "&exist_resultset=" + existResultset;
    ...
    var exportRecord = function () {
        window.location.href = "../../" + module + "_servlet_action?action=export_record&exist_resultset=1";
    }
    var search = function () {
        page_form.submit();
    }
