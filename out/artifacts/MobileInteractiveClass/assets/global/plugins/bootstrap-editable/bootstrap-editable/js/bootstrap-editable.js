...
(function ($) {
    ...
    EditableForm.prototype = {
        ...
        initInput: function() {  //called once
            ...
            //set initial value
            //investigation: may be add check: typeof str === 'string' ?
    ...
    $.fn.editableutils = {
       ...
       */
       createInput: function(options) {
           ...
           //depending on mode and investigation lib
           if(type === 'date') {
               //inline
            ...
            if(!$(document).data('editable-handlers-attached')) {
                ...
                $(document).on('keyup.editable', function (e) {
                    if (e.which === 27) {
                        ...
                        //investigation: return focus on element
                    }
                });
        ...
        **/
        ...
        show: function (closeAll) {
            ...
            */             
            ...
            if(this.$form) {
                //investigation: destroy prev data!
                //this.$form.destroy();
            }
