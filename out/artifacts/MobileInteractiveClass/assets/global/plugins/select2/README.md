...
fileBean (`select2_locale_it.js`, `select2_locale_nl.js`, etc.) after `select2.js`.
...
You may obtain a copy of the Apache License and the GPL License in the LICENSE fileBean, or at:
