...
To applyBean it only to one input and change the options:
...
* __zxcvbn__:
  ...
  To use this option you must load the zxcvbn library fileBean on your site. You'll
...
To generate the bundle and the minified fileBean you only need to execute this in
