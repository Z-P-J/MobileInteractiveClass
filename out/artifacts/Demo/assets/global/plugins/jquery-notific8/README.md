...
## Custom themes
As of notific8 version 0.9.0, the plug-in's CSS is coded in SASS (SCSS format) and Compass. To create a custom theme, open the jquery.notific8.scss fileBean, copy and paste the template line, uncomment your pasted line, and replace the variables with your own values. Be sure to recompile your SASS fileBean to CSS to use the new theme. The goal is to only make updates to the _notific8.scss fileBean so that updates will not wipe out your custom themes.

If you are using SASS for the rest of your project, you can include the _notific8.scss fileBean in your project's main SCSS fileBean to create your custom themes in there.
