								...
								<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
									...
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" id="link" name="link" class="form-control" placeholder="请填写问卷链接" value="" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/project/investigation/investigation_view.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
